...
<div class="container">
    ...
    <div class="panel-group" id="accordion">
        <div class="faqHeader">Programming</div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Java Developer</a>
                </h4>
            </div>
            <div id="collapseOne" class="panel-collapse collapse in">
                <div class="panel-body">
                    This job has been listed by so and so company. Other information here Click to apply
                </div>
            </div>
        </div>
        <div class="panel panel-default">
